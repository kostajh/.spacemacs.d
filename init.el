...
layers configuration. You are free to put any user code."
  ...
  (setq org-agenda-custom-commands
        '(
          ("d" "Daily standup" agenda "tasks scheduled for today"
           (
            (org-agenda-span 'day)
            (org-agenda-column-view nil)
